	...
	function () {
		...
		(function main() {
			...
			try {
				...
				console.log("There were errors during execution of augBuildAllDateField_Report.");
				console.error(error);
			}
			...
			try {
				...
				console.log("There were errors during execution of augBuildAllBooleanField_Report.");
				console.error(error);
			}
			...
			try {
				...
				console.log("There were errors during execution of augModifyResultTable.");
				console.error(error);
			}
			...
			try {
				...
				console.log("There were errors during execution of augAuxilaryFunctions.");
				console.error(error);
			}
