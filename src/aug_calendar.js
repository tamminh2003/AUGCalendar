...
function documentCompleteHandler() {
    try {
        ...
        // document object is not ready, quit execution
        ...
        (function (window) {
            ...
            class Calendar {
                ...
                getAvailableSection() {
                    return this.calendar.sectionManager.sections;
                }
                ...
                createCheckbox(optionContainer, calendarSection) {
                    calendarSection.forEach((c) => {
                        ...
                        // <== Set checked status
                        checkbox.checked = !this.calendar.sectionManager.getHiddenSections().includes(c.id);
                        if (checkbox.checked) {
                        ...
                        // <== Checkbox Handler
                        checkbox.addEventListener('change', e => {
                            let _section = this.calendar.sectionManager.getSection(checkbox.parentElement.dataset.section);
                ...
                createSelectAllButton(buttonContainer, optionSectionContainer) {
                    ...
                    buttonSelectAll.addEventListener('click', e => {
                        ...
                        arrayCheckbox.forEach(c => {
                            ...
                            let _section = this.calendar.sectionManager.getSection(_sectionId);
                ...
                showUserTaskButtonHandler(e) {
                    ...
                    let taskSection = _this.calendar.sectionManager.getSection('tasks');
                ...
                createCustomFilter() {
                    ...
                    if (!showUserTaskButton)
                        showUserTaskButton = wrap.appendChild(BX.create('button', {
                            ...
                            text: this.calendar.sectionManager.getSection('tasks').isShown() ? 'Hide Tasks' : 'Show Tasks'
                        }));
                                    ...
                                    if (eachM.addedNodes.length > 0) {
                                        ...
                                        if (eachM.addedNodes[0].id && eachM.addedNodes[0].id.includes('menu-popup-color-select')) {
                                            ...
                                            for (const eachElem of eachM.addedNodes[0].querySelectorAll('.menu-popup-item-text')) {
                                                ...
                                                switch (eachElem.innerHTML.toUpperCase()) {
                                                    case "#86B100":
